...
<table style="width: 690px;">
    ...
    <tr>
        ...
        <td>{{$form_added['payroll_file_target']}}</td>
        <td>{{$form_added['payroll_file_weight']}}</td>
        <td>{{$form_added['payroll_file_rating_scale']}}</td>
        <td>{{$form_added['payroll_file_final_score']}}</td>
    </tr>
    <tr>
        <td >
            <p>
                TIMEKEEPING (Scheduling or any related concerns of TK)
            </p>
            <p>
                5 - on time with zero errors
            </p>
        ...
        <td>{{$form_added['timekeeping_target']}}</td>
        <td>{{$form_added['timekeeping_weight']}}</td>
        <td>{{$form_added['timekeeping_rating_scale']}}</td>
        <td>{{$form_added['timekeeping_final_score']}}</td>
    </tr>
    <tr>
        <td rowspan="4"> 3 </td>
        <td >
            <p>
                Processing of Benefits (maternity/sickness claims)
            </p>
            <p>
                5 - on time with zero errors
            </p>
        ...
        <td>{{$form_added['processing_target']}}</td>
        <td>{{$form_added['processing_weight']}}</td>
        <td>{{$form_added['processing_rating_scale']}}</td>
        <td>{{$form_added['processing_final_score']}}</td>
    </tr>
    <tr>
        <td >
            <p>
    ...
    <tr>
        <td >
            <p>
                Issuance of employee' s request
            </p>
            <p>
                5 - on time with zero errors
            </p>
        ...
        <td>{{$form_added['inssuance_target']}}</td>
        <td>{{$form_added['inssuance_weight']}}</td>
        <td>{{$form_added['inssuance_rating_scale']}}</td>
        <td>{{$form_added['inssuance_final_score']}}</td>
    </tr>
    <tr>
        <td >
            <p>

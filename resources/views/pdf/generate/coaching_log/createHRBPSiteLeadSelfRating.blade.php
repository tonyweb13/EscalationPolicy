...
<table style="width: 690px;">
    ...
    <tr>
        ...
        <td>{{$form_added['analysis_target']}}</td>
        <td>{{$form_added['analysis_weight']}}</td>
        <td>{{$form_added['analysis_rating_scale']}}</td>
        <td>{{$form_added['analysis_final_score']}}</td>
    </tr>
    <tr>
        <td >
        ...
        <td>{{$form_added['satisfaction_target']}}</td>
        <td>{{$form_added['satisfaction_weight']}}</td>
        <td>{{$form_added['satisfaction_rating_scale']}}</td>
        <td>{{$form_added['satisfaction_final_score']}}</td>
    </tr>
    <tr>
        <td rowspan="2"> 4 </td>

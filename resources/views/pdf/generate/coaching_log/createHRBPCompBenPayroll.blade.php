...
<table style="width: 690px;">
    ...
    <tr>
        ...
        <td>{{$form_added['payroll_reports_target']}}</td>
        <td>{{$form_added['payroll_reports_weight']}}</td>
        <td>{{$form_added['payroll_reports_rating_scale']}}</td>
        <td>{{$form_added['payroll_reports_final_score']}}</td>
    </tr>
    <tr>
        <td rowspan="3"> 3 </td>
        <td >
        ...
        <td>{{$form_added['government_target']}}</td>
        <td>{{$form_added['government_weight']}}</td>
        <td>{{$form_added['government_rating_scale']}}</td>
        <td>{{$form_added['government_final_score']}}</td>
    </tr>
    <tr>
        <td >
            <p>

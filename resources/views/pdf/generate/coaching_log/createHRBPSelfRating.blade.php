...
<table style="width: 690px;">
    ...
    <tr>
        ...
        <td>{{$form_added['critical_thinking_target']}}</td>
        <td>{{$form_added['critical_thinking_weight']}}</td>
        <td>{{$form_added['critical_thinking_rating_scale']}}</td>
        <td>{{$form_added['critical_thinking_final_score']}}</td>
    </tr>
    <tr>
        <td >
    ...
    <tr>
        <td >
            Timely and accurate processing of NTE, Disciplinary Action and escalations in
            compliance to set policies and procedures.
            All trackers are up to date and adherence to the standard turn around time.
        </td>

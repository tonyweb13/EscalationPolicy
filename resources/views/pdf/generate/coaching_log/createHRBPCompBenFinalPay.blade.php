...
<table style="width: 690px;">
	...
	<tr>
		<td colspan="2" style="text-align:left !important">Employee Name</tD>
		<td colspan="2">{{$form_added['employee_name']}}</td>
		<td style="text-align:left !important">Evaluation Period:</td>
		<td >{{$form_added['evaluation_period']}}</td>
	</tr>
	<tr>
		<td colspan="2" style="text-align:left !important">Employee ID:</td>
		<td colspan="2">{{$form_added['employee_id']}}</td>
		<td style="text-align:left !important">Name of Evaluator</td>
		<td >{{$form_added['name_of_evaluator']}}</td>
	</tr>
    <tr>
    ...
    <tr>
        <td >
            <p>
                Accuracy of computation of final pay
            </p>
            <p>
                No of errors:
            </p>
            ...
            <p>
                1 - more than 4 errors
            </p>
        </td>
        <td>{{$form_added['accuracy_computation_target']}}</td>
        <td>{{$form_added['accuracy_computation_weight']}}</td>
        <td>{{$form_added['accuracy_computation_rating_scale']}}</td>
        <td>{{$form_added['accuracy_computation_final_score']}}</td>
    </tr>
    <tr>
        <td rowspan="3"> 3 </td>
        <td >
            <p>
                Timely processing of final pay:
            </p>
            <p>
        ...
        <td>{{$form_added['timely_target']}}</td>
        <td>{{$form_added['timely_weight']}}</td>
        <td>{{$form_added['timely_rating_scale']}}</td>
        <td>{{$form_added['timely_final_score']}}</td>
    </tr>
    <tr>
        <td >
            <p>
        ...
        <td>{{$form_added['submission_of_final_rating_target']}}</td>
        <td>{{$form_added['submission_of_final_rating_weight']}}</td>
        <td>{{$form_added['submission_of_final_rating_scale']}}</td>
        <td>{{$form_added['submission_of_final_rating_final_score']}}</td>
    </tr>
    <tr>
        <td >
            <p>
        ...
        <td>{{$form_added['number_target']}}</td>
        <td>{{$form_added['number_weight']}}</td>
        <td>{{$form_added['number_rating_scale']}}</td>
        <td>{{$form_added['number_final_score']}}</td>
    </tr>
    <tr>

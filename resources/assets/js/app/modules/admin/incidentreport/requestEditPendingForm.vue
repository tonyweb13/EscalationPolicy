            ...
            <the-form :asterisk="asterisk" @submitForm="eventUpdate" class="m-t-xl" >
                <div slot="form-body">
                    <table class="table borderless">
                        ...
                        <tr>
                            <td>
                                <strong>IR Number : </strong> {{ request_data.ir_number }}
                            </td>
                            <td>
...
export default {
    ...
    created(){
        if(this.complainantProps.res_id){
            ...
            //     this.request_data.approver_id = this.user.id;
            // } else {
   ...
   methods: {
        eventUpdate() {
            ...
            getAxios = this.$constants.Incident_API.get("/request_edit", {
                params: {
        ...
        eventApprove: function (ir_number, respondent_id, ir_id, approver_id, id) {
            ...
            this.$swal({
                ...
                .then((result) => {
                    if (result.value) {
                        this.$constants.Incident_API.get("/request_edit/approval/" + respondent_id, {
                            params: {
                                id: id,
                                ir_id: ir_id,

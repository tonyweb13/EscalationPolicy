            ...
            <the-ibox title="">
                <v-client-table :data="rows" :columns="columns" :options="options">
                    ...
                    <template slot="actions" slot-scope="props">
                        ...
                        <div v-else-if="props.row.status_id == 2 || props.row.status_id == 3"
                        style="width:280px;">
                            ...
                            <button class='btn btn-success btn-xs'
                                ...
                                v-if="(rule.incident_report.child_rules.in_progress.child_rules.reply.is_enable
                                || rule.incident_report.child_rules.on_hold.child_rules.reply.is_enable)
                                && ((props.row.second_response == '' || props.row.second_response == null)
                            ...
                            <template v-if="props.row.hrbp_user.id == user.id">
                                <button type="button" class="btn btn-success btn-xs"
                                    v-if="props.row.request_status == 'Pending'"
                            ...
                            <template v-if="props.row.status_id == 2 && props.row.hrbp_user.id == user.id">
                        ...
                        <div v-else-if="props.row.status_id == 4">
                            <span v-if="props.row.incident_report.is_generate_nte_invalid_ir == 2">
                                <h4>Invalid Incident Report</h4>
                            </span>
                            <span v-else>
                                <h4>Valid Incident Report</h4>
                            </span>
                        </div>
                    </template>
                    ...
                    <template slot="complainant" slot-scope="props" v-if="props.row.complainant.complainant_user">
                        <div v-if="props.row.respondent_user_id != user.id">
                    ...
                    <template v-if="props.row.ageing" slot="ageing" slot-scope="props">
                        <span>
                            ...
                            <span v-else-if="props.row.complainant.offense
                                && props.row.complainant.offense.gravity_id != '4'
                                && props.row.ageing > '12'">
                                <b style="color:red">{{ props.row.ageing }} working days</b>
                            </span>
                            <span v-else>
...
<script>
    ...
    export default {
        ...
        data: function () {
            return {
                ...
                complainant_data: {
                    ...
                    comp_respondent_second_response: '',
                    comp_status: '',
        ...
        methods:{
            ...
            getList: function () {
                this.isLoading = true
                this.$constants.Incident_API.get("/status/incident/"+this.incidentProps)
                .then(response => {
            ...
            requestEdit: function (props_row, button_action) {
                ...
                if (props_row) {
                    ...
                    if(props_row.second_response == ''){
                        this.complainant_data.comp_respondent_second_response = '';
                    } else {
                        this.complainant_data.comp_respondent_second_response = props_row.second_response;
                    }
                ...
                if(props_row){
                    ...
                    if (button_action == "note") {
                        ...
                        if (button_action == "view") {
                            ...
                            console.log("list comp_is_generate_nte_invalid_ir="
                            +this.complainant_data.comp_is_generate_nte_invalid_ir);
                    ...
                    if (props_row.complainant.offense) {
                        ...
                        /* multiple Offense */
                        this.complainant_data.comp_offense_id  = JSON.parse(props_row.complainant.offense_id.replace(/\\|"/gi,''));
                    }
                        ...
                        if (props_row.progression_occurence) {
                            ...
                            this.complainant_data.comp_first_offense = String("000000000" + this.complainant_data.comp_first_offense).slice(-9);
                            this.complainant_data.comp_second_offense = String("000000000" + his.complainant_data.comp_second_offense).slice(-9);
                            this.complainant_data.comp_third_offense = String("000000000" + this.complainant_data.comp_third_offense).slice(-9);
                            this.complainant_data.comp_fourth_offense = String("000000000" + his.complainant_data.comp_fourth_offense).slice(-9);
                            this.complainant_data.comp_fifth_offense = String("000000000" + this.complainant_data.comp_fifth_offense).slice(-9);
                            this.complainant_data.comp_sixth_offense = String("000000000" + this.complainant_data.comp_sixth_offense).slice(-9);
                            this.complainant_data.comp_seventh_offense = String("000000000" + this.complainant_data.comp_seventh_offense).slice(-9);
                        }

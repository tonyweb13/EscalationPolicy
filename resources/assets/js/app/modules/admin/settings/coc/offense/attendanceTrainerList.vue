...
<script>
    ...
    export default {
        ...
        created(){
            ...
            if (this.$route.hash == '#attendance-trainer') {
                this.getList();
            }
            this.$bus.$on('categoryList19', this.getList);
        ...
        methods:{
            ...
            // exportCoc: function () {
            //     this.$constants.Coc_API.get("/offense")
            //     .then(response => {

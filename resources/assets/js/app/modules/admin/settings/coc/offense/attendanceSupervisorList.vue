    ...
    <div>
        ...
        <div v-if="categoriesProps">
            <div class="pull-left" style="">
                <h4>Attendance Supervisor and Manager</h4>
            </div>
            <button-add
                @add="addEditRow()"
                thingToAdd="Offense"
...
<script>
    ...
    export default {
        ...
        created(){
            console.log("att sup created this.categoriesProps.category_id==", this.categoriesProps.category_id)
            ...
            console.log("att sup created this.$route.hash==", this.$route.hash)
            if (this.$route.hash == '#attendance-supervisor-and-manager') {
                this.getList();
            }
            this.$bus.$on('categoryList18', this.getList);

<template>
    <ValidationObserver v-slot="{ handleSubmit }">
        <the-form :asterisk="true" @submitForm="handleSubmit(eventUpdate)">
            <div slot="form-body">
                <h3 class="header-tab-cl">Stage Two to Five Form</h3>
                ...
                <table class="table-cl-monthly">
                    <tr>
                        <td class="td-cl-monthly" style="width: 40%;">Key Performance Indicators</td>
                        <td class="td-cl-monthly" style="width: 8%;">Target</td>
                        <td class="td-cl-monthly" style="width: 8%;">Weight</td>
                        <td class="td-cl-monthly" style="width: 8%;" >Rating</td>
                        <td class="td-cl-monthly">Computation (Rating x %)</td>
                        <td class="td-cl-monthly">Comments</td>
                    </tr>
                    <tr>
                        <th class="th-cl-monthly"  colspan="6">Loan Amount</th>
                    </tr>
                    <tr>
                        <td class="td-cl-monthly"  style="text-align: left !important;">
                            ...
                            <button class="btn btn-sm btn-danger" @click="editKeyPerformance(6)">
                            ...
                            style="width: 90%;"><br>
                            <button class="btn btn-sm btn-warning" @click="updateKeyPerformance(6)">
                        ...
                        <td class="td-cl-monthly">
                            <validation-provider rules="required" v-slot="{ errors }">
                                ...
                                v-model="stage_two_to_five.loan_amount_computation" placeholder="Type here....." />
                                <span class="style-red-cl" >{{ errors[0] }}</span><br v-if="errors[0]"/><br v-if="errors[0]"/>
                            </validation-provider>
                        </td>
                        <td class="td-cl-monthly">
                           <validation-provider rules="required" v-slot="{ errors }">
                                <textarea rows="4" cols="104.5" style="width:100%;" 
                                v-model="stage_two_to_five.loan_amount_comment" placeholder="Type here....." />
                                <span class="style-red-cl" >{{ errors[0] }}</span><br v-if="errors[0]"/><br v-if="errors[0]"/>
                            </validation-provider>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="td-cl-monthly"  style="text-align: left !important;">
                            ...
                            <button class="btn btn-sm btn-danger" @click="editKeyPerformance(7)">
                                <i class="fa fa-pencil-square"/> Edit
                            </button>
                            </span>
                            ...
                            style="width: 90%;"><br>
                            <button class="btn btn-sm btn-warning" @click="updateKeyPerformance(7)">
                                <i class="fa fa-save"/> Save Changes
                            </button>
                            </span>
                        </td>
                        ...
                        <td class="td-cl-monthly">
                            <validation-provider rules="required" v-slot="{ errors }">
                                <textarea rows="4" cols="104.5" style="width:100%;" 
                                v-model="stage_two_to_five.qa_score_computation" placeholder="Type here....." />
                                <span class="style-red-cl" >{{ errors[0] }}</span><br v-if="errors[0]"/><br v-if="errors[0]"/>
                            </validation-provider>
                        </td>
                        <td class="td-cl-monthly">
                            <validation-provider rules="required" v-slot="{ errors }">
                                <textarea rows="4" cols="104.5" style="width:100%;" 
                                v-model="stage_two_to_five.qa_score_comment" placeholder="Type here....." />
                                <span class="style-red-cl" >{{ errors[0] }}</span><br v-if="errors[0]"/><br v-if="errors[0]"/>
                            </validation-provider>
                        </td>
                    </tr>
                    <tr>
                        <th class="th-cl-monthly"  colspan="6">QA Compliance</th>
                    </tr>
                    <tr>
                        <td class="td-cl-monthly"  style="text-align: left !important;">
                            ...
                            <button class="btn btn-sm btn-danger" @click="editKeyPerformance(8)">
                                <i class="fa fa-pencil-square"/> Edit
                            </button>
                            </span>
                            ...
                            style="width: 90%;"><br>
                            <button class="btn btn-sm btn-warning" @click="updateKeyPerformance(8)">
                                <i class="fa fa-save"/> Save Changes
                            </button>
                            </span>
                        </td>
                        ...
                        <td class="td-cl-monthly">
                            <validation-provider rules="required" v-slot="{ errors }">
                                <textarea rows="4" cols="104.5" style="width:100%;" 
                                v-model="stage_two_to_five.qa_compliance_computation" placeholder="Type here....." />
                                <span class="style-red-cl" >{{ errors[0] }}</span><br v-if="errors[0]"/><br v-if="errors[0]"/>
                            </validation-provider>
                        </td>
                        <td class="td-cl-monthly">
                            <validation-provider rules="required" v-slot="{ errors }">
                                <textarea rows="4" cols="104.5" style="width:100%;" 
                                v-model="stage_two_to_five.qa_compliance_comment" placeholder="Type here....." />
                                <span class="style-red-cl" >{{ errors[0] }}</span><br v-if="errors[0]"/><br v-if="errors[0]"/>
                            </validation-provider>
                        </td>
                    </tr>
                    <tr>
                        <th class="th-cl-monthly"  colspan="6">Correction</th>
                    </tr>
                    <tr>
                        <td class="td-cl-monthly"  style="text-align: left !important;">
                            ...
                            <button class="btn btn-sm btn-danger" @click="editKeyPerformance(9)">
                                <i class="fa fa-pencil-square"/> Edit
                            </button>
                            </span>
                            ...
                            style="width: 90%;"><br>
                            <button class="btn btn-sm btn-warning" @click="updateKeyPerformance(9)">
                                <i class="fa fa-save"/> Save Changes
                            </button>
                            </span>
                        </td>
                        ...
                        <td class="td-cl-monthly">
                            <validation-provider rules="required" v-slot="{ errors }">
                                <textarea rows="4" cols="104.5" style="width:100%;" 
                                v-model="stage_two_to_five.correction_computation" placeholder="Type here....." />
                                <span class="style-red-cl" >{{ errors[0] }}</span><br v-if="errors[0]"/><br v-if="errors[0]"/>
                            </validation-provider>
                        </td>
                        <td class="td-cl-monthly">
                            <validation-provider rules="required" v-slot="{ errors }">
                                <textarea rows="4" cols="104.5" style="width:100%;" 
                                v-model="stage_two_to_five.correction_comment" placeholder="Type here....." />
                                <span class="style-red-cl" >{{ errors[0] }}</span><br v-if="errors[0]"/><br v-if="errors[0]"/>
                            </validation-provider>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="td-cl-monthly"  style="text-align: left !important;">
                            ...
                            <button class="btn btn-sm btn-danger" @click="editKeyPerformance(10)">
                                <i class="fa fa-pencil-square"/> Edit
                            </button>
                            </span>
                            ...
                            style="width: 90%;"><br>
                            <button class="btn btn-sm btn-warning" @click="updateKeyPerformance(10)">
                                <i class="fa fa-save"/> Save Changes
                            </button>
                            </span>
                        </td>
                        ...
                        <td class="td-cl-monthly">
                            <validation-provider rules="required" v-slot="{ errors }">
                                <textarea rows="4" cols="104.5" style="width:100%;" 
                                v-model="stage_two_to_five.attendance_reliability_computation" placeholder="Type here....." />
                                <span class="style-red-cl" >{{ errors[0] }}</span><br v-if="errors[0]"/><br v-if="errors[0]"/>
                            </validation-provider>
                        </td>
                        <td class="td-cl-monthly">
                            <validation-provider rules="required" v-slot="{ errors }">
                                <textarea rows="4" cols="104.5" style="width:100%;" 
                                v-model="stage_two_to_five.attendance_reliability_comment" placeholder="Type here....." />
                                <span class="style-red-cl" >{{ errors[0] }}</span><br v-if="errors[0]"/><br v-if="errors[0]"/>
                            </validation-provider>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="td-cl-monthly"  colspan="3">
                            <validation-provider rules="required" v-slot="{ errors }">
                                <textarea rows="4" cols="104.5" style="width:100%;" v-model="stage_two_to_five.strengths" placeholder="Type here....." />
                                <span class="style-red-cl" >{{ errors[0] }}</span><br v-if="errors[0]"/><br v-if="errors[0]"/>
                            </validation-provider>
                        </td>
                        <td class="td-cl-monthly"  colspan="3">
                            <validation-provider rules="required" v-slot="{ errors }">
                                <textarea rows="4" cols="104.5" style="width:100%;" v-model="stage_two_to_five.weakness" placeholder="Type here....." />
                                <span class="style-red-cl" >{{ errors[0] }}</span><br v-if="errors[0]"/><br v-if="errors[0]"/>
                            </validation-provider>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="td-cl-monthly"  colspan="6">
                            <validation-provider rules="required" v-slot="{ errors }">
                                <textarea rows="4" cols="104.5" style="width:100%;" v-model="stage_two_to_five.action_plans" placeholder="Type here....." />
                                <span class="style-red-cl" >{{ errors[0] }}</span><br v-if="errors[0]"/><br v-if="errors[0]"/>
                            </validation-provider>
                        </td>
                    </tr>
...
<script>
    export default {
        ...
        created() {
            ...
            this.stage_two_to_five.stage = null;
            let today = new Date()
            ...
            this.listStages = [
			    { "value": "Stage 2", "text": "Stage 2" },
			    { "value": "Stage 3", "text": "Stage 3" },
			    { "value": "Stage 4", "text": "Stage 4" },
                { "value": "Stage 5", "text": "Stage 5" },
        ...
        methods: {
                    ...
                    if (this.coaching_log.selectedForm && response.data.cl_number) {
                        this.$constants.Coaching_API.get('/added_form', {
                                params: {
                                    ...
                                    stage: this.stage_two_to_five.stage.value,
            ...
            keyPerformanceIndicator() {
                this.$constants.Coaching_API.get("/keyperformance/indicator/6")
                .then(response => {
                ...
                this.$constants.Coaching_API.get("/keyperformance/indicator/7")
                .then(response => {
                ...
                this.$constants.Coaching_API.get("/keyperformance/indicator/8")
                .then(response => {
                ...
                this.$constants.Coaching_API.get("/keyperformance/indicator/9")
                .then(response => {
                ...
                this.$constants.Coaching_API.get("/keyperformance/indicator/10")
                .then(response => {
